...
//
    ...
    protected void onStart() {
        super.onStart();;
        FirebaseRecyclerAdapter<Host, ViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Host, ViewHolder>(
                        Host.class,
                        R.layout.row,
                        ViewHolder.class,
                        mRef
                    ...
                    @Override
                    protected void populateViewHolder(ViewHolder viewHolder, Host host, int position) {
                        viewHolder.setDetails(getApplicationContext(), host.getCuisine(), host.getDescription(), host.getImage());
                    }
                };
